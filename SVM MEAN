...
# Memasukkan nilai mean kolom SkinThickness ke variabel (menggantikan nilai yang 0)
any(diabetes$SkinThickness == 0)
mean_skt <- mean(diabetes$SkinThickness[diabetes$SkinThickness != 0], na.rm = TRUE)
mean_skt
diabetes$SkinThickness[diabetes$SkinThickness == 0] <- mean_skt
diabetes$SkinThickness <- round(diabetes$SkinThickness, 1)
any(diabetes$SkinThickness == 0)

# Cek apakah terdapat nilai 0
# Memasukkan nilai mean kolom BloodPressure ke variabel (menggantikan nilai yang 0)
any(diabetes$BloodPressure == 0)
mean_bld <- mean(diabetes$BloodPressure[diabetes$BloodPressure != 0], na.rm = TRUE)
mean_bld
diabetes$BloodPressure[diabetes$BloodPressure == 0] <- mean_bld
...
any(diabetes$Glucose == 0)
mean_glc <- mean(diabetes$Glucose[diabetes$Glucose != 0], na.rm = TRUE)
mean_glc
diabetes$Glucose[diabetes$Glucose == 0] <- mean_glc
...
any(diabetes$BMI == 0)
mean_BMI <- mean(diabetes$BMI[diabetes$BMI != 0], na.rm = TRUE)
mean_BMI
diabetes$BMI[diabetes$BMI == 0] <- mean_BMI
...
# Memasukkan nilai mean kolom BMI ke variabel (menggantikan nilai yang 0)
any(diabetes$Insulin == 0)
mean_Insulin <- mean(diabetes$Insulin[diabetes$Insulin != 0], na.rm = TRUE)
mean_Insulin
diabetes$Insulin[diabetes$Insulin == 0] <- mean_Insulin
